...
describe("HelloWorld", function () {
    ...
    it("Should return true for correct proof", async function () {
        ...
        // Extract the solidity compatible params for Verifier.sol
        // TODO: Learn which value corresponds to which
        ...
        // Put the inputs and output, and proof into the verifier contract
...
describe("Multiplier3 with Groth16", function () {
    ...
    beforeEach(async function () {
        Verifier = await ethers.getContractFactory("GrothMultiplier3Verifier");
        verifier = await Verifier.deploy();
        await verifier.deployed();
    });
    ...
    it("Should return true for correct proof", async function () {
        const { proof, publicSignals } = await groth16.fullProve({ "a": "2", "b": "3", "c": "4" }, "contracts/circuits/GrothMultiplier3/Multiplier3_js/Multiplier3.wasm", "contracts/circuits/GrothMultiplier3/circuit_final.zkey");
